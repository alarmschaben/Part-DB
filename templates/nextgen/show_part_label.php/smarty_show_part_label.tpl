                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="type" {if !$can_edit_option}disabled{/if}>
                                    {foreach $supported_types as $t}
                                        {if $t == 5}<option value="5" {if isset($type) && $type==2}selected{/if}>{t}2D-Barcode (PDF417){/t}</option>{/if}
                                        {if $t == 4}<option value="4" {if isset($type) && $type==2}selected{/if}>{t}2D-Barcode (Datamatrix){/t}</option>{/if}
